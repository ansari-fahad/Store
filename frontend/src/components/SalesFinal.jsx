...
const SalesFinal = () => {
    ...
    const [dsicount, setdsicount] = useState(0);
    ...
    const finalTotal = totalAmount + parseFloat(shippingCharges || 0) - parseFloat(dsicount || 0);
            ...
            <main className="main-content">
                <div className="pos-container">
                    ...
                    <div className="summary" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '15px' }}>
                        <div>
                            <label>dsicount:</label>
                            <input
                                className="pos-input"
                                type="number"
                                value={dsicount}
                                onChange={(e) => setdsicount(parseFloat(e.target.value) || 0)}
                            />
                        </div>
                        <div>
                    ...
                    <div className="actions">
                        ...
                        <button className="btn" style={{ backgroundColor: '#25D366', color: 'white' }} onClick={() => {
                            ...
                            const draftOrder = { customerName, customerPhone, orderID: `DRAFT`, totalAmount: finalTotal, items: cart, dsicount, shippingCharges };
                ...
                <div id="invoice-template" style={{
                    ...
                    <div style={{ textAlign: 'right', marginTop: '20px', color: '#000000' }}>
                        ...
                        <p style={{ margin: '5px 0' }}>dsicount: {Number(dsicount).toFixed(2)}</p>
